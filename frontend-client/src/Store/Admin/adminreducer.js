...
export const AddQuestionToSet=createAsyncThunk('/questionSets/addquestions',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.post('/v1/admin/questionSets/questions',data)
     toast.promise(response,{
...
export const UpdateQuestionToSet=createAsyncThunk('/questionSets/updatequestions',async(data)=>{
    //console.log(data);
    try{
...
export const DeleteQuestionToSet=createAsyncThunk('/questions/delete',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.delete(`/v1/admin/questions/${data?.questionId}`,data)
     toast.promise(response,{
...
export const GetAllQuestionSet=createAsyncThunk('/questionSets/GetAllQuestionSet',async(data)=>{
    //console.log(data);
    try{
...
export const AssignanExamtoSchool=createAsyncThunk('/exams/assign',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.put(`/v1/admin/exams/${data.examId}/assignSchools`,data)
     toast.promise(response,{
...
export const GetallExam=createAsyncThunk('/exams/allExam',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.get('/v1/admin/exams',data)
     toast.promise(response,{
        loading:"wait all exam  is being fetched",
        success: "All Exam has been fetched successfully",
        error:(err)=>{
            return err?.message
        }
     })
...
export const DeleteanExam=createAsyncThunk('/exams/deleteExam',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.delete(`/v1/admin/exams/${data.examId}`,data)
     toast.promise(response,{
...
export const UserCreation=createAsyncThunk('/user/createuser',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.post(`/v1/admin/users/${data.userId}/assignRole`,data)
     toast.promise(response,{
...
export const UserUpdation=createAsyncThunk('/user/updateuser',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.put(`/v1/admin/users/${data.userId}/updateRole`,data)
     toast.promise(response,{
...
export const RoleRemoval=createAsyncThunk('/user/roleremoval',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.put(`/v1/admin/users/${data.userId}/removeRole`,data)
     toast.promise(response,{
...
export const AllUserbyRole=createAsyncThunk('/user/alluser',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.get(`/v1/admin/users/role/${data?.role}`,data)
     toast.promise(response,{
