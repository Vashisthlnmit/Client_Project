...
export const LiveMonitoringofExam=createAsyncThunk('/live',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.get(`/exams/liveMonitor/${data.role}/${data.userId}/${data?.schoolId}`,data)
...
export const PerformanceReportOfUser=createAsyncThunk('/userperformance',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.get(`/exams/performanceReports/${data.role}/${data.userId}/${data?.schoolId}`,data)
     toast.promise(response,{
...
export const SchoolWiseData=createAsyncThunk('/schooldata',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.get(`/exams/schoolWiseData/${data.role}/${data.userId}/${data?.schoolId}`,data)
     toast.promise(response,{
...
export const SchoolWiseReports=createAsyncThunk('/schoolreport',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.get(`/schools/${data.schoolId}/reports`,data)
     toast.promise(response,{
        loading:"wait you are getting performance report",
        success: "Performance report fetched successfully",
        error:(err)=>{
...
export const StateWiseReports=createAsyncThunk('/statereport',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.get(`/state/${data.state}/reports`,data)
     toast.promise(response,{
        loading:"wait you are getting performance report",
        success: "Performance report fetched successfully",
        error:(err)=>{
...
export const CityWiseReports=createAsyncThunk('/cityreport',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.get(`/city/${data.city}/reports`,data)
     toast.promise(response,{
        loading:"wait you are getting performance report",
        success: "Performance report fetched successfully",
        error:(err)=>{
...
export const WorkerWiseReports=createAsyncThunk('/workerreport',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.get(`/worker/${data.workerId}/monitor`,data)
     toast.promise(response,{
        loading:"wait you are getting performance report",
        success: "Performance report fetched successfully",
        error:(err)=>{
...
export const RandomQuestionAssignment=createAsyncThunk('/assignSet',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.post(`/exams/${data.examId}/assignSet`,data)
     toast.promise(response,{
...
export const StartExamByStudent=createAsyncThunk('/start',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.post(`/exams/${data.examId}/start`,data)
     toast.promise(response,{
...
export const SubmitExamByStudent=createAsyncThunk('/submit',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.post(`/exams/${data.examId}/submit`,data)
     toast.promise(response,{
        loading:"wait starting the exam",
        success: "exam has started",
        error:(err)=>{
...
export const AutoSubmissionofExam=createAsyncThunk('/submit',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.post(`/exams/${data.examId}/autoSubmit`,data)
     toast.promise(response,{
        loading:"wait starting the exam",
        success: "exam has started",
        error:(err)=>{
...
export const LiveMonitoringofExambyuser=createAsyncThunk('/livemonitor',async(data)=>{
    //console.log(data);
    try{
     const response=axiosInstance.get(`/exams/${data.examId}/liveMonitor`,data)
     toast.promise(response,{
